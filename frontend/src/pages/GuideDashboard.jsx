...
const GuideDashboard = () => {
    ...
    useEffect(() => {
        const fetchMyTrips = async () => {
            try {
                const res = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/guides/my-trips`, getAuthHeaders());
        ...
        const fetchCompleted = async () => {
            try {
                const res = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/guides/completed`, getAuthHeaders());
